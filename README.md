# ms-odti
My own Microsoft Office Deployment Tool batch installer

## What is this
This is my own batch installer for Microsoft Office 2019 Enterprise VL, which downloads and installs it for you.

## How to use
Simply clone or download this repository on a `.zip` file, decompress it and run the `install.bat` file.

---

# This license applies to the file `setup.exe` copyrighted by Microsoft Corporation.
